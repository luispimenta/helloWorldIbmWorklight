...
window.addEventListener("message", function(e){
	...
	if (typeof plugins[t.service] === 'object') {
		...
		if ((t.service == "File") || (t.service== "FileTransfer") || (t.service== "Geolocation")) {
 ...
 */
var services = ["Network Status", "Media", "Geolocation", "File", "Contacts", "Compass", "Capture", "Camera", "Battery", "Accelerometer", "Device", "FileTransfer", "WifiPlugin", "Scenario", "ScenarioEditor", "ScenarioManager"];
/**
