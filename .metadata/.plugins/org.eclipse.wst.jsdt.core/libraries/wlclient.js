...
__WLClient = function() {
  ...
  /**
    ...
    * 		<td><p>An integer value, denoting the interval in seconds between heartbeat messages automatically sent by <i>WLClient</i> to the Worklight Server. The default value is 1200 (20 minutes).</p></td>
    * 	</tr>
    * 	<tr>
  ...
  /**
    ...
    *   <ul>
    *       <li>The maximum timeout value in any Windows Phone environment is 60000 milliseconds (60 seconds).</li>
    *   </ul>
   ...
   * 
   * Returns true if the last request to the Worklight server was successful.
   * 
   * @methodOf WL.Client#
   */
